...
export const CHAPTERS = [
  ...
  },
  {
    ...
    script: [
      { t: 4, who: A, walk: PLACES.grave.x - 44, speed: 18 },
      { t: 8, who: B, walk: PLACES.grave.x + 30, speed: 18 },
      { t: 30, who: B, pose: 'crouch', face: 'sad', flip: true, at: PLACES.grave.x + 26 },
      { t: 34, who: A, pose: 'sit_knees', face: 'cry', at: PLACES.grave.x - 38 },
      { t: 50, cam: PLACES.grave.x, hold: true },
      { t: 90, who: A, pose: 'stand', face: 'sad' },
      { t: 94, who: B, pose: 'stand', face: 'sad' },
      { t: 104, who: A, pose: 'hold', at: PLACES.grave.x - 42 },
      { t: 104, who: B, pose: 'hold', at: PLACES.grave.x - 26, flip: true },
  ...
  /* ------------------------------------------------ the tree over the years */
  {
    ...
    script: [
      { t: 4, who: A, walk: PLACES.grave.x - 40 },
      { t: 7, who: B, walk: PLACES.grave.x + 30 },
  ...
  },
  {
    ...
    script: [
      { t: 4, who: A, walk: PLACES.grave.x - 38 },
      { t: 7, who: B, walk: PLACES.grave.x + 30 },
      { t: 30, who: A, pose: 'hold', at: PLACES.grave.x - 40 },
      { t: 30, who: B, pose: 'hold', at: PLACES.grave.x - 24, flip: true },
      { t: 84, who: A, walk: ARRIVE_X }, { t: 86, who: B, walk: ARRIVE_X },
    ],
  },
  {
    ...
    script: [
      { t: 4, who: A, walk: PLACES.grave.x - 52, speed: 20 },
      { t: 6, who: B, walk: PLACES.grave.x + 34, speed: 20 },
      { t: 8, who: C, walk: PLACES.grave.x - 28, speed: 34 },
  ...
  },
  {
    ...
    script: [
      { t: 6, who: A, walk: PLACES.grave.x - 50, speed: 18 },
      { t: 9, who: B, walk: PLACES.grave.x - 34, speed: 18 },
      { t: 40, cam: PLACES.grave.x, hold: true },
      { t: 56, who: A, pose: 'stand', face: 'smile', turn: 1 },
      { t: 60, who: B, pose: 'stand', face: 'smile', flip: true },
      { t: 80, who: A, pose: 'hold', at: PLACES.grave.x - 46 },
      { t: 80, who: B, pose: 'hold', at: PLACES.grave.x - 30, flip: true },
      { t: 100, bloomNow: true },
    ],
  },
];
